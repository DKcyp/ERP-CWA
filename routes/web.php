...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('cekRole')->group(function () {
        ...
        Route::prefix('monitoring-pengujian-kemasan')->name('monitoring-pengujian-kemasan.')->group(function () {
            Route::get('/', [MonitoringPengujianKemasanController::class, 'index'])->name('index');
            Route::get('/table', [MonitoringPengujianKemasanController::class, 'table'])->name('table');
            Route::post('/', [MonitoringPengujianKemasanController::class, 'store'])->name('store');
        ...
        Route::prefix('production-process-sppbjadu')->name('production-process-sppbjadu.')->group(function () {
            Route::get('/', [SPPBJAdouController::class, 'index'])->name('index');
        ...
        Route::prefix('production-process-spppk')->name('production-process-spppk.')->group(function () {
            Route::get('/', [SPPPKController::class, 'index'])->name('index');
            Route::get('/table', [SPPPKController::class, 'table'])->name('table');
            Route::post('/', [SPPPKController::class, 'store'])->name('store');
        ...
        Route::prefix('riset-template')->name('riset-template.')->group(function () {
    ...
    Route::prefix('index-komisi-collection')->name('index-komisi-collection.')->group(function () {
        Route::get('/', [IndexKomisiCollectionController::class, 'index'])->name('index');
        Route::get('/table', [IndexKomisiCollectionController::class, 'table'])->name('table');
        Route::post('/', [IndexKomisiCollectionController::class, 'store'])->name('store');
