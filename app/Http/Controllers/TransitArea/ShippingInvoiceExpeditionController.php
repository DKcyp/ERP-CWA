...
class ShippingInvoiceExpeditionController extends Controller
{
    protected DummyStore $store;

    public function __construct()
    {
        $this->store = new DummyStore('shipping_invoice_expedition');
        View::share('activeMenu', 'shipping-invoice-expedition');
    }

    public function index()
    {
        return view('transit-area.shipping-invoice-expedition.index');
    }
