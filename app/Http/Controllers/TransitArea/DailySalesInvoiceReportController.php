...
class DailySalesInvoiceReportController extends Controller
{
    protected DummyStore $store;

    public function __construct()
    {
        $this->store = new DummyStore('daily-sales-invoice-reports');
        View::share('activeMenu', 'daily-sales-invoice-report');
    }

    public function index()
    {
        return view('transit-area.daily-sales-invoice-report.index');
    }
