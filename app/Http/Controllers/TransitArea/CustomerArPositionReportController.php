...
class CustomerArPositionReportController extends Controller
{
    protected DummyStore $store;

    public function __construct()
    {
        $this->store = new DummyStore('customer_ar_position_report');
        View::share('activeMenu', 'customer-ar-position-report');
    }

    public function index()
    {
        return view('transit-area.customer-ar-position-report.index');
    }
