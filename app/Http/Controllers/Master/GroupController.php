...
class GroupController extends Controller
{
    ...
    {
        $this->store = new DummyStore('group');
        View::share('activeMenu', 'group');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','description','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','description','active'));
