...
class SupplierGroupController extends Controller
{
    ...
    {
        $this->store = new DummyStore('supplier-groups');
    }

    public function index(): View
    {
        return view('master.supplier-group.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code', 'name', 'description'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code', 'name', 'description'));
