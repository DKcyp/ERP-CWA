...
class DepartmentController extends Controller
{
    ...
    {
        $this->store = new DummyStore('department');
        View::share('activeMenu', 'department');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','manager','description','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','manager','description','active'));
