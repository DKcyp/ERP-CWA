...
class DiscountMasterController extends Controller
{
    ...
    {
        $this->store = new DummyStore('discount');
        View::share('activeMenu', 'discount');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','type','value','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','type','value','active'));
