...
class SeriesController extends Controller
{
    ...
    {
        $this->store = new DummyStore('series');
        View::share('activeMenu', 'series');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','brand','description','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','brand','description','active'));
