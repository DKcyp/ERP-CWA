...
class QualityController extends Controller
{
    ...
    {
        $this->store = new DummyStore('quality');
        View::share('activeMenu', 'quality');
    }

    public function index()
    {
        return view('master.quality.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','grade','description','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','grade','description','active'));
