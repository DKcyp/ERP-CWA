...
class CategoryController extends Controller
{
    ...
    {
        $this->store = new DummyStore('category');
        View::share('activeMenu', 'category');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','group','description','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','group','description','active'));
