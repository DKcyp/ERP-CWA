...
class CurrencyController extends Controller
{
    ...
    {
        $this->store = new DummyStore('currency');
        View::share('activeMenu', 'currency');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->store->create($request->only('code','name','symbol','is_default','active'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->store->update($id, $request->only('code','name','symbol','is_default','active'));
