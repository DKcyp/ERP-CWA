...
class StockTransferFulfilmentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        View::share('activeMenu', 'stock-transfer-fulfilment');
    }

    public function index()
    {
        return view('material-management.stock-transfer-fulfilment.index');
    }
