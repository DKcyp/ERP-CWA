...
class DailyStockAdjustmentTrackReportController extends Controller
{
    ...
    public function __construct()
    {
        ...
        View::share('activeMenu', 'daily-stock-adjustment-track-report');
    }

    public function index()
    {
        return view('material-management.daily-stock-adjustment-track-report.index');
    }
