            ...
            <div class="row g-3 align-items-end">
                <div class="col-12 col-md-6">
                    <label class="form-label fw-semibold mb-1 small text-muted">
                        <i class="bi bi-search me-1"></i>Cari Center
                    </label>
                ...
                <div class="col-12 col-md-6 d-flex gap-2 justify-content-md-end">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-add-supplier-center">
                        <i class="bi bi-plus-lg me-1"></i>Tambah Center
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm hz-card">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle w-100" id="table-supplier-center">
...
@includeIf('master.supplier-center.form')
@endsection

@include('master.supplier-center.javascript')
