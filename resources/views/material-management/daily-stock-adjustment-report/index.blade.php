...
@section('title', 'Daily Stock Adjustment Report')
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-12 col-md-2">
                    ...
                    <input type="text" class="form-control" id="filter-search" placeholder="Cari nomor, gudang, departemen, PIC...">
                </div>

                <div class="col-12 col-md-2">
                    <label class="form-label fw-semibold mb-1 small text-muted">
                        <i class="bi bi-diagram-2 me-1"></i>Type
                    </label>
...
@include('material-management.daily-stock-adjustment-report.javascript')
