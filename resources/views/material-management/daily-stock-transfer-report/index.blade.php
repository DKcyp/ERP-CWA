...
@section('title', 'Daily Stock Transfer Report')
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm hz-card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="fs-4 fw-bold text-primary" id="summary-total-transfers">0</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm hz-card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="fs-4 fw-bold text-warning" id="summary-total-qty">0</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
...
@include('material-management.daily-stock-transfer-report.javascript')
