...
@section('title', 'Daily Stock Adjustment Cost Report')
...
<div class="page-content">
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input type="text" class="form-control" id="filter-search" placeholder="Cari nomor, gudang, atau departemen...">
                </div>
    ...
    <div class="row g-3 mb-4" id="summary-cards">
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm hz-card h-100">
                <div class="card-body text-center">
                    <div class="text-muted small mb-1">Total Cost Diff</div>
                    <div class="fs-4 fw-bold text-success" id="summary-total-cost-diff">Rp 0</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
                ...
                <table class="table table-hover align-middle w-100" id="table-daily">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-end">Cost Diff</th>
                    ...
                    <table class="table table-bordered table-sm align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-end" style="width:130px;">Cost/Unit</th>
                                <th class="text-end" style="width:140px;">Cost Diff</th>
                            </tr>
                        </thead>
                        ...
                        <tfoot>
                            <tr class="table-light fw-bold">
                                ...
                                <td id="detail-total-cost" class="text-end">Rp 0</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
@include('material-management.daily-stock-adjustment-cost-report.javascript')
