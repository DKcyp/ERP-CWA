            ...
            <div class="row g-3 align-items-end">
                <div class="col-12 col-md-4">
                    <label class="form-label fw-semibold mb-1 small text-muted">
                        <i class="bi bi-search me-1"></i>Cari Retur
                    </label>
                    <input type="text" class="form-control" id="filter-search" placeholder="Cari nomor retur, supplier...">
                </div>
...
@includeIf('material-management.purchase-return.form')
@endsection

@include('material-management.purchase-return.javascript')
