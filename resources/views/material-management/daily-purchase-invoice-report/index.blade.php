...
@section('title', 'Daily Purchase Invoice Report')
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm hz-card h-100">
                <div class="card-body text-center">
                    ...
                    <div class="fs-4 fw-bold text-primary" id="summary-total-invoices">0</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-semibold">Detail Invoice - <span id="detail-inv-number"></span></h5>
            ...
            <div class="modal-body">
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <span id="detail-inv-date" class="fw-semibold">-</span>
                    </div>
                    <div class="col-md-4">
                        <small class="text-muted d-block">No. PO</small>
                        <span id="detail-inv-po" class="fw-semibold">-</span>
                    </div>
                    <div class="col-md-4">
                        <small class="text-muted d-block">Status</small>
                        <span id="detail-inv-status">-</span>
                    </div>
                    <div class="col-md-6">
                        <small class="text-muted d-block">Supplier</small>
                        <span id="detail-inv-supplier" class="fw-semibold">-</span>
                    </div>
                    <div class="col-md-6">
                        <small class="text-muted d-block">Catatan</small>
                        <span id="detail-inv-note" class="fw-semibold">-</span>
                    </div>
                </div>
                <hr>
...
@include('material-management.daily-purchase-invoice-report.javascript')
