...
@section('title','Daily Sales Achievement Report')
@section('content')
    ...
    <div class="card border-0 shadow-sm hz-card mb-4"><div class="card-body">
        <div class="row g-3 align-items-end">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="filter-search" placeholder="Cari TA atau salesman...">
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle w-100 table-sm" id="table-data">
                <thead class="table-light">
                    <tr><th class="text-center">No</th><th>Transit Area</th><th>Salesman</th><th class="text-end">Target</th></tr>
                </thead>
            </table>
        </div>
    </div></div>
...
@push('after-script')
<script>
const tableUrl="{{route('daily-sales-achievement-report.table')}}";
...
{data:'transit_area',name:'transit_area'},{data:'salesman',name:'salesman'},{data:'target_fmt',name:'target',className:'text-end'}
]});
