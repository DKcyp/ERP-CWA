...
@section('title','Invoice Customer AR List Report')
@section('content')
            ...
            <table class="table table-hover align-middle w-100 table-sm" id="table-data">
                <thead class="table-light">
                    <tr>
                        ...
                        <th colspan="12" class="text-center">Bulan Penerbitan</th>
...
@push('after-script')
<script>
const tableUrl="{{route('invoice-customer-ar-list-report.table')}}";
