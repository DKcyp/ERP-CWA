...
@section('title', 'Detail SPPBJ ADU')
...
<div class="card border-0 shadow-sm mb-3">
    ...
    <div class="card-body py-2">
        <div class="row g-2" style="font-size:0.85rem;">
            ...
            <div class="col-md-2"><small class="text-muted d-block">No. SPKP</small><strong>SPKP-ADU-260819-001</strong></div>
            <div class="col-md-2"><small class="text-muted d-block">Kelompok Produk</small><strong>Cat Tembok (Rework)</strong></div>
            <div class="col-md-3"><small class="text-muted d-block">Nama Produk</small><strong>Cat Tembok Putih 25kg (Rework CM)</strong></div>
            <div class="col-md-2"><small class="text-muted d-block">Batch No</small><strong>BATCH-CM-ADU01</strong></div>
            <div class="col-md-2"><small class="text-muted d-block">Tipe Product</small><span class="badge bg-warning text-dark">WB ADU</span></div>
            <div class="col-md-2"><small class="text-muted d-block">Formulasi</small><strong>CM-ADU-001</strong></div>
...
<ul class="nav nav-tabs" id="sppbjTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tabBahanBakuCM" type="button"><i class="bi bi-box-seam me-1"></i>Bahan Baku CM ADU</button>
    </li>
    <li class="nav-item" role="presentation">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tabKemasan" type="button"><i class="bi bi-box me-1"></i>Permintaan Kemasan ADU</button>
    </li>
    <li class="nav-item" role="presentation">
...
<div class="tab-content border border-top-0 rounded-bottom p-3 bg-white shadow-sm">
    ...
    <div class="tab-pane fade" id="tabProduction" role="tabpanel">
        ...
        <div class="mt-2">
            ...
            <button class="btn btn-sm btn-success me-1"><i class="bi bi-check-circle me-1"></i>Complete</button>
            <button class="btn btn-sm btn-warning me-1"><i class="bi bi-play-circle me-1"></i>Proses CM ADU</button>
            <button class="btn btn-sm btn-info"><i class="bi bi-stop-circle me-1"></i>Selesai CM ADU</button>
        </div>
    </div>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success bg-opacity-10 py-2"><h6 class="mb-0 text-success"><i class="bi bi-check-circle me-1"></i>Kesimpulan Produksi CM ADU</h6></div>
