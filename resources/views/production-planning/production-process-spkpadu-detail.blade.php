...
<div class="card border-0 shadow-sm mb-3">
    ...
    <div class="card-body py-2">
        <div class="row g-2" style="font-size:0.85rem;">
            ...
            <div class="col-md-2"><small class="text-muted d-block">No. SPKP</small><strong id="hdrNoSpkp">SPKP-ADU-260819-001</strong></div>
            <div class="col-md-2"><small class="text-muted d-block">Kelompok Produk</small><strong id="hdrKelompok">Cat Tembok (Rework)</strong></div>
            <div class="col-md-3"><small class="text-muted d-block">Nama Produk</small><strong id="hdrProduk">Cat Tembok Putih 25kg (Rework)</strong></div>
            <div class="col-md-2"><small class="text-muted d-block">Batch No</small><strong id="hdrBatch">BATCH-ADU01</strong></div>
            <div class="col-md-2"><small class="text-muted d-block">Tipe Product</small><span class="badge bg-warning text-dark" id="hdrTipe">WB ADU</span></div>
            <div class="col-md-2"><small class="text-muted d-block">Formulasi</small><strong id="hdrFormulasi">ADU-WB-001</strong></div>
...
<ul class="nav nav-tabs" id="spkpTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tabBahanBaku" type="button"><i class="bi bi-box-seam me-1"></i>Bahan Baku ADU</button>
    </li>
    <li class="nav-item" role="presentation">
...
<div class="tab-content border border-top-0 rounded-bottom p-3 bg-white shadow-sm">
    ...
    <div class="tab-pane fade" id="tabProduction" role="tabpanel">
        ...
        <div class="mt-2">
            ...
            <button class="btn btn-sm btn-success me-1"><i class="bi bi-check-circle me-1"></i>Complete</button>
            <button class="btn btn-sm btn-warning me-1"><i class="bi bi-play-circle me-1"></i>Proses ADU</button>
            <button class="btn btn-sm btn-info"><i class="bi bi-stop-circle me-1"></i>Selesai ADU</button>
        </div>
    </div>
